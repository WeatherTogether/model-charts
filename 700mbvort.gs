...
if MODEL = 'GDPS'
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/ISBL_700_HGT_'%FULLH'.ctl'
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/ISBL_700_ABSV_'%FULLH'.ctl'
    else
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/700_mb_HGT_'%FULLH'.ctl'
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/700_mb_ABSV_'%FULLH'.ctl'
endif
...
'd amax(HGT700mb.1/10, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
'd amin(HGT700mb.1/10, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
'd amax(ABSV700mb.2*100000, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
maxlin=sublin(result,i)
maxval=subwrd(maxlin,4)
say result
'q gxinfo'
...
'd amin(ABSV700mb.2*100000, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
minlin=sublin(result,i)
minval=subwrd(minlin,4)
'q gxinfo'
minxlims=sublin(result,3)
...
'set strsiz .13'
'set font 11'
'draw string .4 8.37 700 mb Geopotential Height (dam), Absolute Vorticity (10`a-5`ns`a-1`n)'
*hour
'set strsiz .14'
'set string 1 r'
