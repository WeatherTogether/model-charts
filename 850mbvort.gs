...
if MODEL = 'GDPS'
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/ISBL_850_HGT_'%FULLH'.ctl'
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/ISBL_850_ABSV_'%FULLH'.ctl'
    else
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/850_mb_HGT_'%FULLH'.ctl'
    'open /home/mint/controlfiles/'%MODEL'/'%INIT_INTDATE''%INITHOUR'/850_mb_ABSV_'%FULLH'.ctl'
endif
...
'd amax(HGT850mb.1, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
'd amin(HGT850mb.1, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
'd amax(ABSV850mb.2*100000, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
maxlin=sublin(result,i)
maxval=subwrd(maxlin,4)
say result
'q gxinfo'
...
'd amin(ABSV850mb.2*100000, lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
minlin=sublin(result,i)
minval=subwrd(minlin,4)
'q gxinfo'
minxlims=sublin(result,3)
...
'set strsiz .13'
'set font 11'
'draw string .4 8.37 850 mb Geopotential Height (meters), Absolute Vorticity (10`a-5`ns`a-1`n)'
*hour
'set strsiz .14'
'set string 1 r'
...
*minval
'set string 2 r'
'draw string 5.46 0.30 Min Height: 'minheight' m'
*'draw string 5.46 0.30 Min Vorticity: 'minabsv' 10`a-5`ns`a-1`n'
*maxval
'set string 4 l'
'draw string 5.6 0.30 Max Height: 'maxheight' m'
