...
'gxprint grads_pics/ne_pacific/pwat/00z/Pwat_NEPacific_'%hours'hrfcst.png x1200 y927'
endif

if (hours >9 & hours <=99)
*Save output as .png file in current directory
'gxprint grads_pics/ne_pacific/pwat/00z/Pwat_NEPacific_0'%hours'hrfcst.png x1200 y927'
endif

if (hours <=9)
*Save output as .png file in current directory
'gxprint grads_pics/ne_pacific/pwat/00z/Pwat_NEPacific_00'%hours'hrfcst.png x1200 y927'
endif
endwhile
