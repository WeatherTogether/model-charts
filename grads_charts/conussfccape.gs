*This script plots 1000-500 hPa thickness, SLP, and surface CAPE over a Mercator projection of the CONUS.
...
'draw string .45 7.42 Surface-Based CAPE (shading, J/kg)'
'set strsiz .14'
'set string 1 br'
