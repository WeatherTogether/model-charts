...
BIGGRIB="/home/mint/gribfiles/${MODEL}/${INIT_INTDATE}${INITHOUR}/BIGGRIB"
BIGCTL="/home/mint/controlfiles/${MODEL}/${INIT_INTDATE}${INITHOUR}/BIGCTL.ctl"
...
if [[ `wget -S --spider $URL  2>&1 | grep 'HTTP/1.1 200 OK'` ]]; then 
    ...
    #for ((i=0;i<${#ENSEMBLES[@]};i++)); do
        #for ((h=0;h<=384;h=h+6)); do
            ...
            #    FORECASTHOUR=${h}
            #fi
            GRIBFILE="/home/mint/gribfiles/${MODEL}/${INIT_INTDATE}${INITHOUR}/${INIT_INTDATE}${INITHOUR}_${ENSEMBLES[i]}_${FORECASTHOUR}"
            ...
            #wget -O ${GRIBFILE} ${URL}
            #cat ${GRIBFILE} >> /home/mint/gribfiles/${MODEL}/${INIT_INTDATE}${INITHOUR}/BIGGRIB
            #rm ${GRIBFILE} -rf
        #done
    #done
    RUNDATE=${ENDDATE}
    ...
    GFSBIGCTL="/home/mint/controlfiles/GFS_0.25/${INIT_INTDATE}${INITHOUR}/BIGCTLFORENS.ctl"
    GFSBIGCTLEXT="/home/mint/controlfiles/GFS_0.25/${INIT_INTDATE}${INITHOUR}/BIGCTLEXTFORENS.ctl"
    ...
    for ((i=0;i<${#ICAO[@]};i++)); do
        ...
        #sed -i.bak -e '5,10d;12d' ~/grads_pics/${MODEL}/${ICAO[i]}_850hPaTemp".txt"
