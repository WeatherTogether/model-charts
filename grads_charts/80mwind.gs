...
*set color
'color.gs 0 25 1 -kind (255,255,255,0)-(0)->(255,255,255,0)-(1)->aquamarine->deepskyblue->limegreen->gold->orange->red->firebrick->fuchsia->black'

'd mag(ugrd80m.1,vgrd80m.2)'
...
'set digsiz .04'
if (MODEL = "GFS_0.25")
    'd skip(ugrd80m.1,10,10);vgrd80m.2'
endif
if (MODEL = "NAM_12")
    'd skip(ugrd80m.1,24,24);vgrd80m.2'
endif
if (MODEL = "HRRR_Sub")
    'd skip(ugrd80m.1,60,60);vgrd80m.2'
endif
...
**** MINVAL (Wind)
'd amin(mag(ugrd80m.1,vgrd80m.2), lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
**** MAXVAL (Wind)
'd amax(mag(ugrd80m.1,vgrd80m.2), lon='%LON1', lon='%LON2', lat='%LAT1', lat='%LAT2')'
...
'set strsiz .13'
'set font 11'
'draw string .4 8.35 80-Meter Wind (m/s)'
*hour
'set strsiz .14'
'set string 1 r'
if MODEL='HRRR_Sub'
...
*minval
'set string 4 r'
'draw string 5.46 0.30 Min Wind: 'minval_wind' m/s'
*maxval
'set string 2 l'
'draw string 5.6 0.30 Max Wind: 'maxval_wind' m/s'
*weathertogether.net
'set font 11'
'set strsiz .14'
'set string 11 r'
