...
'set strsiz .13'
'set font 11'
'draw string .4 8.4 500 mb Geopotential Height Anomalies (shaded, based on 1981-2010 Climatology, dam), Geopotential Heights (contours, dam)
*hour
'set strsiz .14'
'set string 1 r'
